        ...
        <div className='flex'>
            ...
            <Navbar />
                ...
                <div className='flex justify-around text-center mx-3 font-bold'>
                    <h5 className='bg-white w-full py-2 mx-1 cursor-pointer hover:underline'>Videos</h5>
                    <h5 className='bg-white w-full py-2 mx-1 cursor-pointer hover:underline'>Playlists</h5>
                    <h5 className='bg-white w-full py-2 mx-1 cursor-pointer hover:underline'>Tweets</h5>
                    <h5 className='bg-white w-full py-2 mx-1 cursor-pointer hover:underline'>Following</h5>
                </div>
            </div>
        </div>
    </>
